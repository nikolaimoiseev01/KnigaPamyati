<a wire:navigate href="{{route('portal.veteran', $veteran['id'])}}" class="block font-mono carousel-card w-[200px] shrink-0 bg-coral-300 rounded shadow p-2 hover:scale-[1.03] transition duration-200">
