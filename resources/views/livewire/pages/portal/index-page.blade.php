    ...
    <section style="background-image: url('/fixed/welcome_background.jpeg')"
        ...
        <div class="sticky-content-wide flex justify-between absolute left-1/2 -translate-x-1/2 z-10 w-full bottom-20">
            ...
            <div class="flex gap-4">
                ...
                <p class="w-[590px] text-[1vw]">Интернет-проект «Книга памяти» посвящается 80-летию Победы советского
    ...
    <section style="background-image: url('/fixed/block_3_image.jpeg')"
        ...
        <div class="py-48 sticky-content-wide">
            <h2 class=" text-[4vw] relative mb-16">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                Пока нами собрана лишь <span class="text-coral-500">часть имён<br>
                и часть историй</span>. Со Дня Великой Победы<br> 9 мая 1945 года прошло 80 лет и в живых<br>
                свидетелей тех времён становится всё меньше<br>
                и меньше. Но мы продолжим наш поиск и будем<br>
                вписывать новые страницы<br>
                в нашу «Книгу памяти»</h2>
            <div class="sticky-content-secondary relative flex justify-between text-bright-85 text-[1vw]">
                <div class="flex gap-4">
                    <img class="w-[8vw] my-auto" src="/fixed/medal_lenin.png" alt="">
                    <svg class="w-4 mt-2" width="12" height="11" viewBox="0 0 12 11" fill="none"
                         xmlns="http://www.w3.org/2000/svg">
                        <path
                            d="M11.1462 4.3999C11.971 4.7402 11.971 5.90842 11.1462 6.24872L2.09163 9.98444C1.43337 10.256 0.710236 9.77211 0.710236 9.06002V1.5886C0.710236 0.876514 1.43337 0.3926 2.09163 0.664185L11.1462 4.3999Z"
                    ...
                    <p>с момента учреждения<br> ордена Ленина было<br> произведено 431 418<br> награждений</p>
                </div>
                <div class="flex gap-4">
                    <svg class="w-4 mt-2" width="12" height="11" viewBox="0 0 12 11" fill="none"
                         xmlns="http://www.w3.org/2000/svg">
                    ...
                    <p class="w-80">В 2023 году в России оставалось<br> <span class="text-coral-500">всего 1 759</span>
    ...
    <section style="background-image: url('/fixed/block_3_image.jpeg')"
        ...
        <div class="py-48 sticky-content-wide">
            <h2 class=" text-[4vw] relative mb-16">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                ...
                публикациям, поэтому <span class="text-coral-500">могут содержать<br> неточности.</span>
                Если вы увидели фактическую ошибку,<br>
