    ...
    <section class="mb-16">
        <div class="grid grid-cols-12 items-end gap-4 mb-16  md:flex md:flex-col md:gap-4">
            ...
            <div class="col-start-7 col-span-6 md:col-start-1 md:col-span-12 md:mx-auto flex flex-col">
                ...
                <h1 class="font-light text-8xl lg:text-6xl md:text-center">{{$veteran['birth_dt']}}-{{$veteran['death_dt']}}</h1>
            </div>
        </div>
        <div class="sticky-content-wide"><p class="text-2xl lg:text-xl md:!text-base">{{$veteran['description']}}</p></div>
    </section>
